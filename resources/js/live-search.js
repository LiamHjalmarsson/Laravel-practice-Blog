...
export default class Search {
    ...
    constructor() {
        this.injectHTML(); // injecting html for the search 
    ...
    async sendRequest() {
        ...
        // can juse fetch Axios has extra features and makes ending HTTP request easy 
        // comes from the file that comes with larvael from ./bootstrap and imports it 
                ...
                return `
                    <a href="/post/${post.id}" class="list-group-item list-group-item-action">
                        ...
                        <span class="text-muted small">
                            by ${post.user.username} on ${postDate.getMonth() + 1}/${postDate.getDate()}/${postDate.getFullYear()}
                        </span>
                    </a>`;
            }).join("")}
            </div>`);
